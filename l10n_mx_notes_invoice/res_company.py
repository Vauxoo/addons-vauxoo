...
class res_company(osv.Model):
    ...
    _columns = {
        ...
        'sample_text' : fields.text('Promissory not', readonly=True),
    ...
    _defaults = {
        'details' : "In the field 'Promissory note' you need put the text "\
            ...
            "in text' as follows : 'name_variable' : object.value of object, "\
        ...
        'sample' : 'If you like put the text \nI Partner pay to the order of '\
            'My Company the amount of $500.00, you need put:',
        'sample_text' : "'I %(partner_name)s pay to the order of %(company_"\
            "name)s the amount of %(invoice_amount)s'",
        'sample_dict' : "'partner_name' : partner.name, 'company_name' : "\
