...
0. Clone this repository:
    ...
    ```bash
    $ git clone git@github.com:vauxoo/addons-vauxoo.git -b 19.0
    $ cd addons-vauxoo
...
1. **Before declaring this repository as part of your addons-path:** Install all
   ...
   you have v19.0 installed.

2. Create your own branch locally.

    ```bash
    $ git checkout -b 19.0-your_new_feature_theme-your-name
    ```

3. Push your first change branch to know you start to work on.

    ```bash
    $ git push -u origin 19.0-your_new_feature_theme-your-name
    ```
...
4. Prepare your environment to work with this repository and the mandatory ones
   to have all the environment ready.
    ...
    $ git clone https://github.com/vauxoo/addons-vauxoo.git -b 19.0
    ```
...
12. Push your first change branch to know you start to work on.
    ...
    ```bash
    $ git push -u your-name 19.0-your_new_feature_theme-your-name
    ```
...
- How? Follow [odoo?s](https://github.com/odoo/odoo/blob/19.0/CONTRIBUTING.md) standard to put your issues.
