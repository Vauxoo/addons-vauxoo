...
def css2excel(css):
    ...
    process_css = {
        ...
        'vertical-align': [align, "horz", lambda x : {'top':'top', 'middle':'center', 'bottom':'bottom', 'justify': align.HORZ_JUSTIFIED}[x]],
        'background-color' : [pattern,"pattern_fore_colour", lambda x: excel_color_map.get(x,-7)+8],
    }
