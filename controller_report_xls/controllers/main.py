...
class ReportController(main.ReportController):
    ...
    def report_download(self, data, token):
        ...
        headers.update({"Content-Disposition": "attachment; filename=%s.xls;" % reportname})
    ...
    def report_routes(self, reportname, docids=None, converter=None, **data):
        ...
        if not context.get("xls_report"):
            return super().report_routes(reportname, docids=origin_docids, converter=converter, **data)
