...
class purchase_request(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context):
        super(purchase_request, self).__init__(cr, uid, name, context=context)
    ...
    def _get_partner_addr(self, idp):
        if not idp:
            return []
...
report_sxw.report_sxw(
    'report.purchase.request.vauxoo',
    'purchase.order',
    'addons/purchase_request/report/order_vauxoo.rml',
    parser=purchase_request,
    header = False 
)
