...
class account_invoice_tax(osv.osv):
    ...
    _columns = {
        'name2': fields.function(_get_tax_data, method=True, type='char', size=64, string='Name2', multi='tax_percent', store=False),
        'tax_percent': fields.function(_get_tax_data, method=True, type='float', string='Tax Percent', multi='tax_percent', store=False),
    }
account_invoice_tax()
