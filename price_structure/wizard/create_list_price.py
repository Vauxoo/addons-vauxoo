...
class virtual_items(osv.osv_memory):
    ...
    _columns = {
            'pricelist_id':fields.many2one('create.price.list', 'List'), 
...
class create_price_list(osv.osv_memory):
    ...
    def default_get(self, cr, uid, fields, context=None):
        ...
        if context is None:
            context = {}
        res = super(create_price_list, self).default_get(cr, uid, fields, context=context)
    ...
    def onchage_versions(self, cr, uid, ids, pricelist, context=None):
        ...
        if pricelist:
           version_ids = version_obj.search(cr, uid, [('pricelist_id','=',pricelist)], context=context)
