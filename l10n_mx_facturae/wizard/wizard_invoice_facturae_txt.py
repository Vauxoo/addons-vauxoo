    ...
    states = {
        'init' : {
            ...
            'result' : {'type' : 'form',
                        'arch' : _form,
                        'fields' : _fields,
                        'state' : [ ('end', '_Cancel'), ('get_invoices_date', 'Obtener Facturas por filtro de _Fechas'), ('get_invoices_month', 'Obtener Facturas por filtro de _Mes'), ('export', '_Generar Reporte Mensual TXT', 'gtk-ok', 'True') ]}
        },
