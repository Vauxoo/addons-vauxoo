...
class CrmTeam(models.Model):
    ...
    default_warehouse_id = fields.Many2one(
        "stock.warehouse",
        help="In this field can be defined a default warehouse for the related users to the sales team.",
    )
    ...
    def _get_default_team_id(self, user_id=None, domain=None):
        ...
        if user_id is not None and self.env.context.get("keep_current_user_salesteam") and self.env.user.sale_team_id:
