...
class InheritedCrmSaseSection(models.Model):
    ...
    def _default_get(self, fields_list):
        ...
        '''
        defaults = BaseModel.default_get.origin(self, fields_list)
        ...
        if warehouse_id:
            ...
            fields_data = fields_obj.search([('model_id', '=', model_id.id),
                                            ('relation', '=',
                                             'stock.warehouse'),
                                            ('ttype', '=', 'many2one')])
            names_list = []
    ...
    BaseModel._patch_method('default_get', _default_get)
