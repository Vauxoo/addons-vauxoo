...
class account_invoice_facturae_pac_sf_disc_pdf(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context):
        super(account_invoice_facturae_pac_sf_disc_pdf, self).__init__(cr, uid, name, context=context)
...
report_sxw.report_sxw(
    'report.account.invoice.facturae.pac.sf.disc.pdf',
    'account.invoice',
    'addons/l10n_mx_invoice_discount/report/invoice_facturae_pac_sf_disc_pdf.rml',
    header=False,
    parser=account_invoice_facturae_pac_sf_disc_pdf,
)
